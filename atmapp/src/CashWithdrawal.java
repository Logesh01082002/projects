    ...
    public CashWithdrawal(int atno1,int acno1,int pno1,String actype1)
     {
		...
		l4 = new JLabel("Cash Withdrawal");
		l4.setFont(new Font("Times New Roman", Font.BOLD, 30));
		l4.setForeground(new Color(0, 51, 102)); // Dark Blue
		l4.setBounds(250, 250, 250, 30);
		jf.add(l4);

		l3 = new JLabel("Enter the amount to be withdrawn:");
		l3.setFont(f1);
		...
		b2.setBackground(new Color(0, 51, 102)); // Dark Blue
		jf.add(b2);
		...
		b3.setBackground(new Color(0, 51, 102)); // Dark Blue
		jf.add(b3);
