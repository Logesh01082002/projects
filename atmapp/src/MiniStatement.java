...
public class MiniStatement extends JFrame implements ActionListener
{
    ...
    public MiniStatement(int atno1,int acno1,int pno1,String actype1)
    {
		...
		l7 = new JLabel("For more information visit our nearest branch of COCO Bank.");
		l7.setFont(f1);
		l7.setForeground(Color.blue);
		l7.setBounds(60, 520, 690, 20);
		jf.add(l7);

		l8 = new JLabel("Visit www.cocobank.com or call Toll-free no 1800 2000 1911 .");
		l8.setFont(f1);
		...
		b1.setBackground(new Color(0, 102, 204)); // Dark Blue
		jf.add(b1);
