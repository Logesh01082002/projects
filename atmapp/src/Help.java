...
public class Help extends JFrame implements ActionListener
{
    ...
    Timer t;
		...
		Help()
		{
			...
			l3 = new JLabel("Cash withdrawal options used to get money from the ATM.");
			l3.setFont(f);
			...
			l7 = new JLabel("Loan information option used to give various loan rates.");
			l7.setFont(f);
			l7.setForeground(Color.WHITE);
			l7.setBounds(40, 420, 650, 25);
			jf.add(l7);

			l8 = new JLabel("For more information visit your nearest branch of our Bank.");
			l8.setFont(f);
			...
			l10 = new JLabel("Mr Logesh E");
			l10.setFont(f1);
			l10.setForeground(Color.RED);
			l10.setBounds(340, 480, 250, 30);
			jf.add(l10);

			l11 = new JLabel("Under the guidance of ");
			l11.setFont(f);
			l11.setForeground(Color.RED);
			l11.setBounds(40, 510, 200, 20);
			jf.add(l11);

			l12 = new JLabel(" GOOGLE.");
			l12.setFont(f1);
			...
			cancel.setBackground(new Color(0, 102, 204)); // Dark Blue
			jf.add(cancel);
