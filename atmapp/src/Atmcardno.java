    ...
    public Atmcardno()
     {
		...
		l4.setForeground(new Color(30, 144, 255)); // Dodger Blue
		l4.setBounds(250, 250, 300, 30);
		jf.add(l4);

		l2 = new JLabel("Enter ATM card no:");
		l2.setFont(f1);
		l2.setForeground(new Color(0,153,0)); // dark green
		...
		l3.setFont(f1);
		l3.setForeground(new Color(0,153,0));// White
		...
		b1.setBackground(new Color(30, 144, 255)); // Dodger Blue
		jf.add(b1);
		...
		b2.setBackground(new Color(30, 144, 255)); // Dodger Blue
		jf.add(b2);
		...
		b3.setBackground(new Color(30, 144, 255)); // Dodger Blue
		jf.add(b3);
		...
		jf.setVisible(true);
	     ...
	     t =new Timer(30000,this);// 20 minisecond
         t.start();
